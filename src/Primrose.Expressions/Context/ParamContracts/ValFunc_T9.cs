...
{
  internal class ValFunc< T1, T2, T3, T4, T5, T6, T7, T8, T9> : IValFunc
  {
    private readonly Func<IContext, T1, T2, T3, T4, T5, T6, T7, T8, T9, Val> F;
    public ValFunc(Func<IContext, T1, T2, T3, T4, T5, T6, T7, T8, T9, Val> fn) { F = fn; }

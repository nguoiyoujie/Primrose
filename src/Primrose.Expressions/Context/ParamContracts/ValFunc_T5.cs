...
{
  internal class ValFunc<T1, T2, T3, T4, T5> : IValFunc
  {
    private readonly FunctionDelegate<T1, T2, T3, T4, T5> F;
    public ValFunc(FunctionDelegate<T1, T2, T3, T4, T5> fn) { F = fn; }

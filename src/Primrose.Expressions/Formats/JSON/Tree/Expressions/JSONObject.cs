...
namespace Primrose.Expressions.Formats.JSON.Tree.Expressions.Literals
{
  internal class JSONObject : CLiteral
  {
    // {x:y}
    // x is string
    // y can be a literal, array or another json object
    ...
    internal JSONObject(ContextScope scope, Lexer lexer) : base(scope, lexer)
    {
